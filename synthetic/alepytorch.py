...
def _first_order_ale_quant(predictor, dataset, feature, bins):
    ...
    for offset in range(2):
        ...
        predictions.append(predictor(mod_dataset[:,0].reshape((-1,1)),mod_dataset[:,1].reshape((-1,1)),mod_dataset[:,2].reshape((-1,1))))
...
def _second_order_ale_quant(predictor, dataset, features, bins):
